    ...
    <div>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        <Contact icon={Phone} label="Phone">
          <a href={`tel:${m.phone}`} className="text-accent hover:underline">
            {m.phone}
          </a>
        </Contact>
        {m.business && (
          <Contact icon={Building} label="Business">
            {m.business}
          </Contact>
        )}
        <Contact icon={MapPin} label="Suburb / site">
          {m.suburb}
        </Contact>
      </div>
      ...
      <div className="mt-5 grid gap-3 rounded-lg border border-border bg-muted/30 p-4 text-sm sm:grid-cols-2">
        ...
        <Detail label="Need" value={m.need} />
        <Detail label="Start date" value={m.start_date} />
        <Detail label="Duration" value={m.duration} />
        <Detail label="Product stored" value={m.product} />
        <Detail label="Storage volume" value={m.volume} />
        <Detail label="Power supply" value={m.power} />
        <Detail
          label="Site access"
          value={m.access.length ? m.access.join(", ") : null}
        />
      </div>
