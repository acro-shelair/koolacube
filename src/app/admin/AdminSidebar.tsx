...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Units", href: "/admin/units", icon: Boxes, permission: "units" },
      {
        label: "Industries",
...
export default function AdminSidebar({
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-navy-deep border-b border-white/10 flex items-center gap-3 px-4 h-14">
        <button
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-60 bg-navy-deep flex flex-col z-50 transition-transform duration-300 md:translate-x-0 ${
