        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            {PERMISSION_KEYS.map((k) => (
              <label
                key={k}
                className="flex cursor-pointer items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm hover:bg-muted has-[:checked]:border-accent has-[:checked]:bg-accent/5"
              >
                <input
                  type="checkbox"
