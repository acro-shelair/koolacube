...
export const metadata = { title: "Pages | Koolacube Admin" };
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Edit the text and SEO of every page. Pages show “Customised” once edited;
          otherwise they use the built-in copy.
        </p>
      </div>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {customised && (
                          <span className="shrink-0 rounded bg-accent/15 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-accent">
                            Customised
                          </span>
                        )}
                      </div>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg bg-accent px-3 py-2 text-sm font-medium text-accent-foreground transition hover:opacity-90"
                    >
